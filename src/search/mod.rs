...
tuneable_params! {
    ...
    LMR_TEMP_SCALE, i32, 476, 0, 1024;
    STATIC_EVAL_TEMP_BONUS, i32, 239, 0, 1024;
    TT_SCORE_TEMP_BONUS, i32, 242, 0, 1024;
    IMPROVING_TEMP_BONUS, i32, 278, 0, 1024;
    OPP_WORSENING_TEMP_BONUS, i32, 123, 0, 1024;
    RAZOR_HIGH_TEMP_BONUS, i32, 126, 0, 1024;
    PROBCUT_HIGH_TEMP_BONUS, i32, 242, 0, 1024;
    BAD_STAGE_TEMP_MALUS, i32, -348, -1024, 0;

    // Tempterature entry cutoffs
    TT_FP_TEMP_MINIMUM, i32, -108, -1024, 1024;
    IIR_TEMP_MINIMUM, i32, -88, -1024, 1024;
    NMP_TEMP_MINIMUM, i32, -112, -1024, 1024;
    PROBCUT_TEMP_MINIMUM, i32, -21, -1024, 1024;
    LMR_TEMP_REDUCTION_MINIMUM, i32, 0, -1024, 1024;
    MOVEPICKER_CUTNODE_TEMP_MINIMUM, i32, -76, -1024, 1024;
    RAZORING_TEMP_MAXIMUM, i32, 22, -1024, 1024;
