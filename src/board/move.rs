...
pub const SPECIAL_FLAG: u16 = 0b1100_0000_0000_0000;
...
impl Move {
    ...
    pub fn is_promotion(self) -> bool {
        self.data & SPECIAL_FLAG == PROMOTION_FLAG
    }

    #[must_use]
    pub fn is_castling(self) -> bool {
        self.data & SPECIAL_FLAG == CASTLING_FLAG
    }

    #[must_use]
    pub fn is_en_passant(self) -> bool {
        self.data & SPECIAL_FLAG == EN_PASSANT_FLAG
    }
...
pub fn encode_move(from: Square, to: Square, promoted_piece: Option<PieceType>, flag: u16) -> Move {
    if flag & SPECIAL_FLAG == PROMOTION_FLAG {
