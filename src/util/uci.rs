        ...
        _ => {
            if let [name, "value", x] = words[2..] {
                try_set_param!(
                    ...
                    LMR_TEMP_HIGH_A,
                    LMR_TEMP_HIGH_B,
                    STATIC_EVAL_TEMP_BONUS,
                    TT_SCORE_TEMP_BONUS,
                    IMPROVING_TEMP_BONUS,
                    OPP_WORSENING_TEMP_BONUS,
                    RAZOR_HIGH_TEMP_BONUS,
                    PROBCUT_HIGH_TEMP_BONUS,
                    BAD_STAGE_TEMP_MALUS,
                    TEMP_FAILING_LOW_SCALE,
                    TT_FP_TEMP_MINIMUM,
                    IIR_TEMP_MINIMUM,
                    NMP_TEMP_MINIMUM,
                    PROBCUT_TEMP_MINIMUM,
                    LMR_TEMP_REDUCTION_MINIMUM,
                    MOVEPICKER_CUTNODE_TEMP_MINIMUM,
                    RAZORING_TEMP_MAXIMUM,
                    RFP_BETA_WEIGHT,
                    NMP_BETA_WEIGHT,
