...
tuneable_params! {
    SINGULARITY_DE_MARGIN, i32, 29, 10, 150;
    ASPIRATION_WINDOW, i32, 18, 10, 70;
    RAZORING_MARGIN, i32, 264, 100, 500;
    MAX_RAZOR_DEPTH, u8, 6, 1, 12;
    BETA_PRUNING_DEPTH, u8, 5, 1, 12;
    BETA_PRUNING_MARGIN, u8, 37, 20, 200;
    ALPHA_PRUNING_DEPTH, u8, 5, 1, 12;
    ALPHA_PRUNING_MARGIN, i32, 2007, 500, 5000;
    SEE_PRUNING_DEPTH, i32, 7, 1, 12;
    SEE_QUIET_MARGIN, i32, 76, 50, 300;
    SEE_NOISY_MARGIN, i32, 30, 20, 250;
    SEE_QSEARCH_MARGIN, i32, 41, 1, 100;
    LMP_DEPTH, u8, 4, 1, 12;
    IIR_DEPTH_MINIMUM, u8, 8, 1, 12;
    HASH_MOVE_SCORE, i32, 1_000_000, 1_000_000, 1_000_000;
    QUEEN_PROMOTION, i32, 774696, 0, 999_999;
    WINNING_CAPTURE, i32, 367507, 0, 999_999;
    FIRST_KILLER_MOVE, i32, 189807, 0, 999_999;
