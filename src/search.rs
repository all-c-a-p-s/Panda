...
tuneable_params! {
    SINGULARITY_DE_MARGIN, i32, 17, 10, 150;
    ASPIRATION_WINDOW, i32, 16, 10, 70;
    RAZORING_MARGIN, i32, 289, 100, 500;
    MAX_RAZOR_DEPTH, u8, 3, 1, 12;
    BETA_PRUNING_DEPTH, u8, 5, 1, 12;
    BETA_PRUNING_MARGIN, u8, 21, 20, 200;
    ALPHA_PRUNING_DEPTH, u8, 8, 1, 12;
    ALPHA_PRUNING_MARGIN, i32, 2059, 500, 5000;
    SEE_PRUNING_DEPTH, i32, 9, 1, 12;
    SEE_QUIET_MARGIN, i32, 72, 50, 300;
    SEE_NOISY_MARGIN, i32, 36, 20, 250;
    SEE_QSEARCH_MARGIN, i32, 11, 1, 100;
    QSEARCH_FP_MARGIN, i32, 166, 1, 350;
    LMP_DEPTH, u8, 6, 1, 12;
    IIR_DEPTH_MINIMUM, u8, 11, 1, 12;
    HASH_MOVE_SCORE, i32, 1_000_000, 1_000_000, 1_000_000;
    QUEEN_PROMOTION, i32, 645_558, -999_999, 999_999;
    WINNING_CAPTURE, i32, 394_168, -999_999, 999_999;
    FIRST_KILLER_MOVE, i32, 127_569, -999_999, 999_999;
    SECOND_KILLER_MOVE, i32, 44_226, -999_999, 999_999;
    LOSING_CAPTURE, i32, -281_790, -999_999, 999_999;
    UNDER_PROMOTION, i32, -45_759, -999_999, 999_999;
    COUNTERMOVE_BONUS, i32, 56_442, -999_999, 999999;
}
